...
HD_PWD='E:/Documents/Xilinx Projects/basys3_7segdisplay/basys3_7segdisplay.runs/design_1_btn_debounce_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_btn_debounce_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_btn_debounce_0_0.tcl
